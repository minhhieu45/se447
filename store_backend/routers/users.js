...
router.post(
  ...
  async function (req, res) {
    let { email, username, password, address, numberphone } = req.body;
    try {
      var token = await jwt.sign(
        { email, username, password, address, numberphone },
        process.env.SECRET
      );
      var transporter = nodemailer.createTransport({
        service: "tientrieu10111@gmail.com",
        auth: {
          user: "tientrieu10111@gmail.com",
          pass: "ksfdjrveeptgtsmm",
        },
      });
      var mailOptions = {
...
<!--HEADER -->
 ...
 <img style="display:block; line-height:0px; font-size:0px; border:0px;" src="https://cdn.pixabay.com/photo/2017/08/05/00/12/girl-2581913_960_720.jpg" width="100%" height="100%" alt="logo">
 </td>
 </tr>
 ...
 WELCOME <span style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 5px;">TO TIENDZ STORE</span>
 </td>
 </tr>
...
<!-- START SHOWCASE -->
 ...
 Thank you for registering an account on our website
 </td>
 </tr>
 ...
 <tr align="center">
 <td style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575; line-height:24px; font-weight: 300;">tientrieu10111@gmail.com</td>
 </tr>
 ...
 <tr align="center">
 <td style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575; line-height:24px; font-weight: 300;">See more at my website</td>
 </tr>
...
<!-- END PRICING -->
<a style="color: white; background-color: black; padding: 10px 15px; border-radius: 6px; position: fixed; top: 300px" href="http://localhost:9000/register?token=${token}">Click Me To verify</a>
...
router.post("/", UserController.checkRole);
...
router.delete("/feedback/:id", UserController.deleteFeedblack);
